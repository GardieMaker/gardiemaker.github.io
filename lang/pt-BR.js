...
// support variables
	...
	var infoGeneralT = [
	    ...
	    'answer':'Para relatar qualquer erro ou problema que você encontra no funcionamento do vestiário ou do perfil, você pode deixar um <a href="https://gardiemaker.blogspot.com/p/reportar-un-problema.html">comentário aqui</a> ou enviar um e-mail para <a href="mailto:gardiemaker@gmail.com">gardiemaker@gmail.com</a> (espanhol ou inglês de preferência) com o assunto "Reporte"*. Esteja ciente que, se for um defeito de funcionamento, é necessário detalhar o contexto que o levou a esse erro (se você removeu uma peça de roupa, mudou algum filtro, etc.) e qual é o erro (não carregou, carregou algo errado, etc.).'},
	    {'question':'Páginas Parceiras / Afiliações',
	    'answer':'<h4>O que é uma afiliação?</h4>A afiliação (também conhecida como "páginas parceiras") é um acordo amigável entre duas pessoas ou dois grupos de pessoas, no qual ambos concordam em promover o blog/página da outra pessoa em troca da outra página promover seu próprio blog/página, com o propósito de um anunciar o outro.<br><br><h4>Como eu posso me afiliar?</h4>É muito simples! Basta me enviar um e-mail para <a href="mailto:gardiemaker@gmail.com">gardiemaker@gmail.com</a> (espanhol ou inglês de preferência) o assunto "Afiliación" e me enviar o link do seu blog ou página + um banner/botão para que eu possa promovê-lo aqui. Claro, a afiliação terá que ser mútua, então vou verificar se você tem qualquer banner meu antes de adicionar o seu banner.<br><br><h4>Banners de GardieMaker</h4><a href="https://64.media.tumblr.com/a4026aa525a63eaf98bd34ca36f98ce0/tumblr_inline_qcf3hrcRaT1wxxmsr_500.png" target="_blank" title="70x70"><img src="https://64.media.tumblr.com/a4026aa525a63eaf98bd34ca36f98ce0/tumblr_inline_qcf3hrcRaT1wxxmsr_500.png"></a> <a href="https://64.media.tumblr.com/da8dd9efb4fd8c6376ad00a1c84c437e/tumblr_inline_qcf3i6GPJE1wxxmsr_500.png" target="_blank" title="150x70"><img src="https://64.media.tumblr.com/da8dd9efb4fd8c6376ad00a1c84c437e/tumblr_inline_qcf3i6GPJE1wxxmsr_500.png"></a><br><br><u>NOTA:</u> Se você for me promover, use o link limpo (https://gardiemaker.github.io).'},
	    {'question':'Servidores / Traduções (en-US / fr-FR)',
	    'answer':'Eu adoraria traduzir GardieMaker para outras línguas, mas é impossível eu fazer isso sozinha. Se você estiver interessado e quiser me ajudar a traduzir GardieMaker para o idioma do seu servidor, envie um e-mail para <a href="mailto:gardiemaker@gmail.com">gardiemaker@gmail.com</a> (espanhol ou inglês de preferência).<br></br><b>Servidor FR:</b> Preciso de ajuda para traduzir pelo menos a interface. As wikis estão bastantes completas, então caso queiram me ajudar com os nomes das roupas é só me dizer.<br></br><b>Servidor BR:</b> Traduzido por Becky ( <a href="https://www.twitter.com/denkimoon" target="_blank">Twitter</a> / <a href="https://www.facebook.com/starfightersimp" target="_blank">Facebook</a> ).<br><br><b>Outros servidores:</b> Preciso de ajuda para traduzir a interface e todos os nomes das roupas.<br></br><b>IMPORTANTE</b><br>É desnecessário dizer, mas muitas vezes eu mudo o texto ocasional na interface, então você precisará estar realmente disposto em manter as traduções atualizadas.'},
	    {'question':'Dúvidas?',
	...
	var infoWardrobeT = [
	    ...
	    'answer':'O vestiário funciona com códigos que estão localizados em um link. Se você não consegue carregar nenhuma roupa, verifique se o link não está corrompido. Tente reiniciar o vestiário com o botão no canto superior direito ou <a href="wardrobe">clicando aqui</a>. Se o erro persistir, contate via e-mail para <a href="mailto:gardiemaker@gmail.com">gardiemaker@gmail.com</a> (espanhol ou inglês de preferência).'},
	    {'question':'O vestiário se reinicia sozinho e não consigo usar-lo.',
	    'answer':'O vestiário é preparado para que, se houver algum problema ao carregar os itens, ele se reinicia. Se a página se recarregar mais de 4 vezes, é provável que seja um problema do servidor. A melhor opção é esperar um pouco e usar mais tarde. Se o problema persistir, não hesite em me mandar um e-mail para <a href="mailto:gardiemaker@gmail.com">gardiemaker@gmail.com.</a> (espanhol ou inglês de preferência).'},
	    {'question':'Falta trajes ou peças de x evento.',
	    'answer':'Se for um evento antigo, te peço paciência. Trabalho dia após dia para juntar as roupas de uma por uma, e conseguir os códigos é mais entediante do que parece.<br><br>Se for um evento ativo e é um evento de exploração, pode levar no máximo dois ou três dias após o evento coletar todas os trajes. Se for um evento de missão ou minigame, não posso me dar ao luxo de concluir com MO, então você terá que esperar o fim do evento para que seja adicionado.<br><br>Se o evento acabou e você ainda está esperando pelas roupas novas, talvez você devesse visitar o blog com mais frequência ou pelo menos usar a barrinha de pesquisa do vestiário. As roupas não são classificadas por ordem de partida, e sim pelos seus códigos, então você nem sempre verá novas roupas no topo da lista.'},
	    {'question':'As peças animadas não se movem.',
	    'answer':'E não vão. Só coloquei as imagens, porque era bastante tedioso colocar as animações.'},
	    {'question':'Filtros Manuais',
	    'answer':'Além dos filtros comuns já visíveis, o vestiário tem alguns filtros especiais. São chamados de "manuais", já que são palavras chaves que devem ser digitados na barra de pesquisa. Atualmente, os filtros manuais são:<ul><li><u>Códigos:</u> As peças podem ser pesquisadas pelo seu código exato.</li><li><u>Arco-íris:</u> Esses itens não tem um filtro normal, mas agora podem ser filtradas manualmente, é só digitar "#rainbow" na barrinha de pesquisa.</li><li><u>Peroladas:</u> Usando #shiny pode filtrar as peças peroladas.</li><li><u>Eventos:</u> Você pode filtrar os tiens por eventos específicos. para usar esse filtro basta digitar a sigla do evento e o ano do mesmo, e colocar os dois pontos (":") entre a sigla e o ano. Por exemplo: "DN:2018" o "dn:2018" mostra todas as peças do evento de Dia dos Namorados 2018. Você também pode utilizar somente a sigla ("DN:" ou "dn:") para procurar todas os trajes dos eventos de Dia dos Namorados, ou então somente o ano (":2018"), para filtrar todas as peças dos trajes que foram lançados naquele ano. As siglas disponíveis atualmente são:<ul><li>A = 1 de Abril</li><li>DN = Dia dos Namorados</li><li>P = Páscoa</li><li>M = Música</li><li>JE = Japan Expo</li><li>MO = Mês do Orgulho</li><li>V = Verão</li><li>BF = Black Friday</li><li>H = Halloween</li><li>N = Natal</li></ul></li></ul><u>NOTA:</u> Lembre-se que para usar o filtro de eventos, você deve usar os dois pontos (":") para "ativá-lo".'},
	    {'question':'O que são os asterísticos (*) que tem em alguns itens?',
	    'answer':'Os itens com asterísticos são peças que cujo os nomes não correspondem ao nome original no servidor espanhol. Os nomes estão corrigidos. Você pode ver todas as correções <a href="https://gardiemaker.blogspot.com/2020/04/correcciones-y-cambios.html">neste post</a>.'},
	    {'question':'Como salvo a guardiã que eu criei?',
	...
	var infoContestsT = [
	    ...
	    'answer':'Se a guardiã que você enviou não estiver no catálogo, pode ser por esses motivos:<br><ul><li><u>Inválida:</u> O código estava corrompido ou eu não consegui carregar-lo.</li><li><u>A guardiã não tem roupa:</u> Aqui não é lugar para guardar bases.</li><li><u>O apelido ou e-mail não correspondem:</u> É provável que o email que você queira usar já estava sendo usado em outra conta, seja porque você já enviou antes ou alguém está utilizando seu e-mail. Nesse caso, eu recomendo você enviar um email para <a href="gardiemaker@gmail.com">gardiemaker@gmail.com</a> (espanhol ou inglês de preferência) para eu lhe ajudar, e assim, garantir que não seja outra pessoa tentando roubar sua conta.'},
	    {'question':'Relatar um cosplay.',
	    'answer':'Se você ver algum cosplay que não está marcado como cosplay, você pode fazer um relatório utilizando o botão "Notificar cosplay", que é localizado no canto inferior direito de cada contribuição. Também pode relatar via email a <a href="gardiemaker@gmail.com">gardiemaker@gmail.com</a> ou deixando um comentário na página de relatórios. Certifique-se de enviar o ID e o apelido (ou seja, o nome da pessoa que enviou) dessa contribuição, junto com o personagem que está apresentando para que poder verificar.'},
	    {'question':'Eu posso fazer um concurso ou atividade com o seu vestiário?',
	    'answer':'É claro! O vestiário é gratuito para quem quiser realizar concursos ou qualquer coisa derivada.<br><br>Se você tem interesse em organizar algum concurso/atividade aqui mesmo, não hesite em me enviar um e-mail para <a href="mailto:gardiemaker@gmail.com">gardiemaker@gmail.com</a> (espanhol ou inglês de preferência) com os detalhes e veremos o que pode ser feito.'}
	];